...
if ($_GET[request] == "check_status_checkin"){
  ...
  if($_GET[status]==1){  
?>
 <div class="font-20"><i class="fa  fa-clock-o fa-spin 6x" style="color:#88B34D"></i>&nbsp;<strong><?=t_time;?>&nbsp;<?=$date = date('H:i:s', $_GET[time]);?></strong></div>
<? }  
  if($_GET[status]==0){  
?>
 <div class="font-20"><i class="fa fa-circle-o-notch fa-spin 6x" style="color:#FF0000"></i>&nbsp;<font color="#FF0000"><?=t_pending;?></font></div>
<? } 
  if($_GET[status]==2){  
?>
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td> <div class="font-20"><i class="fa  fa-circle-o-notch fa-spin 6x" style="color:#FF0000"></i><?=t_customer_no_register;?>
