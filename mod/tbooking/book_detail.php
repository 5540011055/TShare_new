...
<a onclick="hideDetail();" style="" ><i class="fa fa-times font_close_icon" aria-hidden="true"></i></a>
</div>
					...
					<td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td valign="top" class="td-text"><span class="font-22"><?=$_POST[car_type][pax_th];?></span></td>
                           </tr>
                        </tbody>
                     </table>
					</td>
...
<button onclick="selectjob('<?=$_POST[orderid];?>','<?=$_POST[id];?>','<?=$_POST[invoice];?>','<?=$_POST[code];?>','<?=$_POST[program][id];?>','<?=$_POST[pickup_place][id];?>','<?=$_POST[to_place][id];?>','<?=$_POST[agent];?>','<?=$_POST[airout_time];?>','<?=$_POST[airin_time];?>','<?=$_POST[cost];?>','<?=$_POST[s_cost];?>','<?=$_POST[outdate];?>','<?=$_POST[ondate];?>','<?=$_POST[s_status_pay];?>','<?=$_POST[car_type][id];?>','<?=$car_type;?>','<?=$_POST[car_type][pax_th];?>','<?=$arr[ct][topic_th];?>','<?=$arr[ct][pax_th];?>')" style="margin-top:10px;background-color: #fff;border: 1px solid #3b5998;width: 100%;border-radius: 25px;padding: 8px;color: #3b5998; "><span class="font-24"><strong><?=t_accept_order?></strong></span> </button>
</div>
