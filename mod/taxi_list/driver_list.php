...
<div style="padding: 0px;">
	<table width="100%">
		<tr>
			<td width="50%" style="padding: 0px 5px;"><input type="text" placeholder="ค้นหาจากชื่อ" value="" style="border: 1px solid #ddd; width: 100%;" class="font-22" id="search_dv_name"  /></td>
			<td width="50%" style="padding: 0px 5px;"><input type="text" placeholder="ค้นหาจากเบอร์โทร" value="" style="border: 1px solid #ddd; width: 100%;" class="font-22" id="search_dv_phone"  /></td>
		</tr>
	</table>
</div>
<table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp" width="100%" style="white-space: normal;">
  <thead>
    <tr>
