...
<div>
     <div class="toolbar-head" style="">
	  <div class="left close-left">
        <a class="link back button-close-popup-mod-4">
            <div class="" style="color: #333"><i class="fa fa-close" style="font-size:22px;"></i></div>
        </a>
      </div>
      <div class="title font-24" style="margin-top: 8px;width: 100%;" align="center" ><b><span id="text_mod_topic_action_4" class="text-topic-action-mod-4" ></span></b></div>
