...
<ul id="slide-out" class="side-nav" style="transform: translateX(-310px);">
		<li style="margin-top: 15px;"><a class="collapsible-header waves-effect waves-main font-26" onclick="openTaxiList();"><i class="fa fa-book icon_menu" style="margin-top: 1px !important;"></i><?=รายชื่อคนขับทั้งหมด;?></a></li>
         ...
         <li class="padding-5"><a class="collapsible-header waves-effect waves-main font-26" onclick="openQrCode();"><i class="fa fa-qrcode icon_menu" style="margin-top: 1px !important;"></i><?=t_friends;?></a></li>
        <!-- <li style="display: none;"><a class="waves-effect waves-main" href="startup-team.html" style="padding: 0px 16px;"><?=t_language;?></a></li>-->
         <li class="padding-5"><a class="collapsible-header waves-effect waves-main font-26" onclick="logOut();"><i class="icon-new-uniF186 icon_menu"></i><?=t_sign_out;?></a></li>
      </ul>
