        ...
        var b = {
            init: function(b) {
                ...
                b = a.extend(c, b), a(this).each(function() {
                    ...
                    b.draggable ? (f.length && f.remove(), f = a('<div class="drag-target" onclick="hideMenu();"></div>').attr("data-sidenav", d), a("body").append(f)) : f = a(), "left" == b.edge ? (e.css("transform", "translateX(-100%)"), f.css({
                        left: 0
                    ...
                    b.draggable && (f.on("click", function() {
                        ...
                        if (i === !0) i = !1, h = !1, g();
                            ...
                            var c = a("body"),
                                d = a('<div id="sidenav-overlay" onclick="hideMenu();"></div>'),
                                j = c.innerWidth();
