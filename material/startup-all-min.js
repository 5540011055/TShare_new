...
function() {
        ...
        function r(i) {
            function r() {
                if (!f) {
                    ...
                    if (h = function() {
                        ...
                        o.appendChild(r);
                        var a = h(r);
                        c = 200 === e(a.width), o.removeChild(r)
                    }
                }
            }
            ...
            function a(t) {
                if (r(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var a = s.isBorderBox = !(!u || !i[u] || "border-box" !== i[u]), f = 0, p = o.length; p > f; f++) {
                        var d = o[f],
                            m = i[d];
                        m = l(t, m);
                        var _ = parseFloat(m);
                    ...
                    var S = e(i.height);
                    return S !== !1 && (s.height = S + (b ? 0 : v + x)), s.innerWidth = s.width - (g + w), s.innerHeight = s.height - (v + x), s.outerWidth = s.width + y, s.outerHeight = s.height + T, s
                }
            }
            ...
            e(function() {
                for (var e = n.toDashed(r), o = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", l = 0, h = o.length; h > l; l++) {
                    ...
                    try {
                        ...
                        s && s.error("Error parsing " + a + " on " + c.nodeName.toLowerCase() + (c.id ? "#" + c.id : "") + ": " + p);
                        continue
                    }
                    var d = new i(c, u),
                        m = t.jQuery;
    ...
    function(t, e) {
        ...
        }, o.prototype.moveTo = f ? o.prototype._transitionTo : o.prototype.goTo, o.prototype.setPosition = function(t, e) {
    ...
    function(t, e) {
        ...
        return n.prototype._resetLayout = function() {
            ...
            for (var s = this._getColGroup(r), o = Math.min.apply(Math, s), a = i.indexOf(s, o), l = {
                    ...
                    y: o
                }, h = o + t.size.outerHeight, u = this.cols + 1 - s.length, c = 0; u > c; c++) this.colYs[a + c] = h;
            return l
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                var n = function(t) {
                    ...
                    u = [];
                r.version = "1.15.1", h.constructor = r, h.kill()._gc = !1, r.killTweensOf = r.killDelayedCallsTo = i.killTweensOf, r.getTweensOf = i.getTweensOf, r.lagSmoothing = i.lagSmoothing, r.ticker = i.ticker, r.render = i.render, h.invalidate = function() {
                    ...
                    var n, r, a, l, h, c, f, p, d = this._dirty ? this.totalDuration() : this._totalDuration,
                        m = this._time,
                        _ = this._totalTime,
                        g = this._cycle,
                        v = this._duration,
                        y = this._rawPrevTime;
                    if (t >= d ? (this._totalTime = d, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = v, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (n = !0, r = "onComplete"), 0 === v && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > y || y === s) && y !== t && (i = !0, y > s && (r = "onReverseComplete")), this._rawPrevTime = p = !e || t || y === t ? t : s)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== _ || 0 === v && y > 0 && y !== s) && (r = "onReverseComplete", n = this._reversed), 0 > t && (this._active = !1, 0 === v && (this._initted || !this.vars.lazy || i) && (y >= 0 && (i = !0), this._rawPrevTime = p = !e || t || y === t ? t : s)), this._initted || (i = !0)) : (this._totalTime = this._time = t, 0 !== this._repeat && (l = v + this._repeatDelay, this._cycle = this._totalTime / l >> 0, 0 !== this._cycle && this._cycle === this._totalTime / l && this._cycle--, this._time = this._totalTime - this._cycle * l, this._yoyo && 0 !== (1 & this._cycle) && (this._time = v - this._time), this._time > v ? this._time = v : 0 > this._time && (this._time = 0)), this._easeType ? (h = this._time / v, c = this._easeType, f = this._easePower, (1 === c || 3 === c && h >= .5) && (h = 1 - h), 3 === c && (h *= 2), 1 === f ? h *= h : 2 === f ? h *= h * h : 3 === f ? h *= h * h * h : 4 === f && (h *= h * h * h * h), this.ratio = 1 === c ? 1 - h : 2 === c ? h : .5 > this._time / v ? h / 2 : 1 - h / 2) : this.ratio = this._ease.getRatio(this._time / v)), m === this._time && !i && g === this._cycle) return void(_ !== this._totalTime && this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || u)));
                    if (!this._initted) {
                    ...
                    for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== m && t >= 0 && (this._active = !0), 0 === _ && (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = "_dummyGS")), this.vars.onStart && (0 !== this._totalTime || 0 === v) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || u))), a = this._firstPT; a;) a.f ? a.t[a.p](a.c * this.ratio + a.s) : a.t[a.p] = a.c * this.ratio + a.s, a = a._next;
                    this._onUpdate && (0 > t && this._startAt && this._startTime && this._startAt.render(t, e, i), e || (this._totalTime !== _ || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || u)), this._cycle !== g && (e || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || u)), r && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && this._startTime && this._startAt.render(t, e, i), n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[r] && this.vars[r].apply(this.vars[r + "Scope"] || this, this.vars[r + "Params"] || u), 0 === v && this._rawPrevTime === s && p !== s && (this._rawPrevTime = 0))
                }, r.to = function(t, e, i) {
                    return new r(t, e, i)
                ...
                }, r.staggerTo = r.allTo = function(t, e, s, o, h, c, f) {
                    o = o || 0;
                    var p, d, m, _, g = s.delay || 0,
                        v = [],
                        y = function() {
                    ...
                    for (l(t) || ("string" == typeof t && (t = i.selector(t) || t), a(t) && (t = n(t))), t = t || [], 0 > o && (t = n(t), t.reverse(), o *= -1), p = t.length - 1, m = 0; p >= m; m++) {
                        d = {};
                        for (_ in s) d[_] = s[_];
                        d.delay = g, m === p && h && (d.onComplete = y), v[m] = new r(t[m], e, d), g += o
                    }
                    return v
                ...
                r.killAll = function(t, i, n, r) {
                    ...
                    if (null != t) {
                        var s, h, u, c, f, p = o.tweenLookup;
                        if ("string" == typeof t && (t = i.selector(t) || t), a(t) && (t = n(t)), l(t))
                            for (c = t.length; --c > -1;) r.killChildTweensOf(t[c], e);
                        else {
                            s = [];
                            for (u in p)
                                for (h = p[u].target.parentNode; h;) h === t && (s = s.concat(p[u].tweens)), h = h.parentNode;
                ...
                var n = function(t) {
                    ...
                    _ = n.prototype = new e;
                return n.version = "1.15.1", _.constructor = n, _.kill()._gc = _._forcingPlayhead = !1, _.to = function(t, e, n, r) {
                    ...
                    if ("number" != typeof s && (s = this._parseTimeOrLabel(s, 0, !0, r)), !(r instanceof t)) {
                        if (r instanceof Array || r && r.push && l(r)) {
                            for (o = o || "normal", a = a || 0, h = s, u = r.length, c = 0; u > c; c++) l(f = r[c]) && (f = new n({
                                tweens: f
                    ...
                    if (t >= f ? (this._totalTime = this._time = f, this._reversed || this._hasPausedChild() || (s = !0, a = "onComplete", 0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (l = !0, this._rawPrevTime > r && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = f + 1e-4) : 1e-7 > t ? (this._totalTime = this._time = 0, (0 !== p || 0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (a = "onReverseComplete", s = this._reversed), 0 > t ? (this._active = !1, this._rawPrevTime >= 0 && this._first && (l = !0), this._rawPrevTime = t) : (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (l = !0))) : this._totalTime = this._time = this._rawPrevTime = t, this._time !== p && this._first || i || l) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== p && t > 0 && (this._active = !0), 0 === p && this.vars.onStart && 0 !== this._time && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || c)), this._time >= p)
                            ...
                            for (n = this._last; n && (o = n._prev, !this._paused || _);)(n._active || p >= n._startTime && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)), n = o;
                        this._onUpdate && (e || (h.length && u(), this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || c))), a && (this._gc || (d === this._startTime || m !== this._timeScale) && (0 === this._time || f >= this.totalDuration()) && (s && (h.length && u(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[a] && this.vars[a].apply(this.vars[a + "Scope"] || this, this.vars[a + "Params"] || c)))
                    }
                ...
                return u.constructor = n, u.kill()._gc = !1, n.version = "1.15.1", u.invalidate = function() {
                    ...
                    this._gc && this._enabled(!0, !1);
                    var n, o, h, u, c, f, p = this._dirty ? this.totalDuration() : this._totalDuration,
                        d = this._duration,
                        m = this._time,
                        _ = this._totalTime,
                        g = this._startTime,
                    ...
                    if (t >= p ? (this._locked || (this._totalTime = p, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (o = !0, u = "onComplete", 0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && (c = !0, y > r && (u = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, this._yoyo && 0 !== (1 & this._cycle) ? this._time = t = 0 : (this._time = d, t = d + 1e-4)) : 1e-7 > t ? (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== m || 0 === d && y !== r && (y > 0 || 0 > t && y >= 0) && !this._locked) && (u = "onReverseComplete", o = this._reversed), 0 > t ? (this._active = !1, y >= 0 && this._first && (c = !0), this._rawPrevTime = t) : (this._rawPrevTime = d || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (c = !0))) : (0 === d && 0 > y && (c = !0), this._time = this._rawPrevTime = t, this._locked || (this._totalTime = t, 0 !== this._repeat && (f = d + this._repeatDelay, this._cycle = this._totalTime / f >> 0, 0 !== this._cycle && this._cycle === this._totalTime / f && this._cycle--, this._time = this._totalTime - this._cycle * f, this._yoyo && 0 !== (1 & this._cycle) && (this._time = d - this._time), this._time > d ? (this._time = d, t = d + 1e-4) : 0 > this._time ? this._time = t = 0 : t = this._time))), this._cycle !== w && !this._locked) {
                        var x = this._yoyo && 0 !== (1 & w),
                            ...
                            C = this._rawPrevTime,
                            O = this._time;
                        if (this._totalTime = w * d, w > this._cycle ? x = !x : this._totalTime += d, this._time = m, this._rawPrevTime = 0 === d ? y - 1e-4 : y, this._cycle = w, this._locked = !0, m = x ? 0 : d, this.render(m, e, 0 === d), e || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || s), b && (m = x ? d + 1e-4 : -1e-4, this.render(m, !0, !1)), this._locked = !1, this._paused && !T) return;
                        this._time = O, this._totalTime = P, this._cycle = S, this._rawPrevTime = C
                    }
                    if (!(this._time !== m && this._first || i || c)) return void(_ !== this._totalTime && this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s)));
                    if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== _ && t > 0 && (this._active = !0), 0 === _ && this.vars.onStart && 0 !== this._totalTime && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || s)), this._time >= m)
                        for (n = this._first; n && (h = n._next, !this._paused || T);)(n._active || n._startTime <= this._time && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)), n = h;
                    else
                        for (n = this._last; n && (h = n._prev, !this._paused || T);)(n._active || m >= n._startTime && !n._paused && !n._gc) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)), n = h;
                    this._onUpdate && (e || (a.length && l(), this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s))), u && (this._locked || this._gc || (g === this._startTime || v !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (o && (a.length && l(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[u] && this.vars[u].apply(this.vars[u + "Scope"] || this, this.vars[u + "Params"] || s)))
            ...
            function() {
                var t = 180 / Math.PI,
                    ...
                    h = function(t, r, s, o, a) {
                        var h, u, c, f, p, d, m, _, g, v, y, T, w, x = t.length - 1,
                            b = 0,
                            P = t[0].a;
                        for (h = 0; x > h; h++) p = t[b], u = p.a, c = p.d, f = t[b + 1].d, a ? (y = e[h], T = i[h], w = .25 * (T + y) * r / (o ? .5 : n[h] || .5), d = c - (c - u) * (o ? .5 * r : 0 !== y ? w / y : 0), m = c + (f - c) * (o ? .5 * r : 0 !== T ? w / T : 0), _ = c - (d + ((m - d) * (3 * y / (y + T) + .5) / 4 || 0))) : (d = c - .5 * (c - u) * r, m = c + .5 * (f - c) * r, _ = c - (d + m) / 2), d += _, m += _, p.c = g = d, p.b = 0 !== h ? P : P = p.a + .6 * (p.c - p.a), p.da = c - u, p.ca = g - u, p.ba = P - u, s ? (v = l(u, P, g, c), t.splice(b, 1, v[0], v[1], v[2], v[3]), b += 4) : b++, P = m;
                    ...
                    u = function(t, n, r, s) {
                        ...
                        for (l = 0; a > l; l++) h = t[l][n], u = t[l + 1][n], p[l] = new o(h, 0, 0, u), r && (c = t[l + 2][n], e[l] = (e[l] || 0) + (u - h) * (u - h), i[l] = (i[l] || 0) + (c - u) * (c - u));
                        return p[l] = new o(t[l][n], 0, 0, t[l + 1][n]), p
                    },
                    c = function(t, s, o, l, c, f) {
                        var p, d, m, _, g, v, y, T, w = {},
                            x = [],
                            b = f || t[0];
                        ...
                        if (t.length > 1) {
                            for (T = t[t.length - 1], y = !0, p = x.length; --p > -1;)
                                if (d = x[p], Math.abs(b[d] - T[d]) > .05) {
                                    y = !1;
                                    break
                                }
                            y && (t = t.concat(), f && t.unshift(f), t.push(t[1]), f = t[t.length - 3])
                        }
                        for (e.length = i.length = n.length = 0, p = x.length; --p > -1;) d = x[p], r[d] = -1 !== c.indexOf("," + d + ","), w[d] = u(t, d, r[d], f);
                        for (p = e.length; --p > -1;) e[p] = Math.sqrt(e[p]), i[p] = Math.sqrt(i[p]);
                        if (!l) {
                            for (p = x.length; --p > -1;)
                                if (r[d])
                                    for (m = w[x[p]], v = m.length - 1, _ = 0; v > _; _++) g = m[_ + 1].da / i[_] + m[_].da / e[_], n[_] = (n[_] || 0) + g * g;
                            for (p = n.length; --p > -1;) n[p] = Math.sqrt(n[p])
                        }
                        for (p = x.length, _ = o ? 4 : 1; --p > -1;) d = x[p], m = w[d], h(m, s, o, l, r[d]), y && (m.splice(0, _), m.splice(m.length - _, _));
                        return w
                    },
                    f = function(t, e, i) {
                        e = e || "soft";
                        ...
                        for (h = v.length; --h > -1;) {
                            for (f = v[h], m[f] = l = [], p = 0, c = t.length, u = 0; c > u; u++) n = null == i ? t[u][f] : "string" == typeof(d = t[u][f]) && "=" === d.charAt(1) ? i[f] + Number(d.charAt(0) + d.substr(2)) : Number(d), g && u > 1 && c - 1 > u && (l[p++] = (n + l[p - 2]) / 2), l[p++] = n;
                            for (c = p - _ + 1, p = 0, u = 0; c > u; u += _) n = l[u], r = l[u + 1], s = l[u + 2], a = 2 === _ ? 0 : l[u + 3], l[p++] = d = 3 === _ ? new o(n, r, s, a) : new o(n, (2 * r + n) / 3, (2 * r + s) / 3, s);
                            l.length = p
                        }
                        return m
                    },
                    p = function(t, e, i) {
                        for (var n, r, s, o, a, l, h, u, c, f, p, d = 1 / i, m = t.length; --m > -1;)
                            for (f = t[m], s = f.a, o = f.d - s, a = f.c - s, l = f.b - s, n = r = 0, u = 1; i >= u; u++) h = d * u, c = 1 - h, n = r - (r = (h * h * o + 3 * c * (h * a + c * l)) * h), p = m * i + u - 1, e[p] = (e[p] || 0) + n * n
                    },
                    d = function(t, e) {
                        e = e >> 0 || 6;
                        var i, n, r, s, o = [],
                        ...
                        set: function(e) {
                            ...
                            if (this._timeRes) {
                                if (u = this._lengths, c = this._curSeg, e *= this._length, r = this._li, e > this._l2 && f - 1 > r) {
                                    for (h = f - 1; h > r && e >= (this._l2 = u[++r]););
                                    this._l1 = u[r - 1], this._li = r, this._curSeg = c = this._segments[r], this._s2 = c[this._s1 = this._si = 0]
                                } else if (this._l1 > e && r > 0) {
                                    for (; r > 0 && (this._l1 = u[--r]) >= e;);
                                    0 === r && this._l1 > e ? this._l1 = 0 : r++, this._l2 = u[r], this._li = r, this._curSeg = c = this._segments[r],
                            ...
                            if (this._autoRotate) {
                                ...
                                for (r = b.length; --r > -1;) s = b[r][2], w = b[r][3] || 0, x = b[r][4] === !0 ? 1 : t, o = this._beziers[b[r][0]], _ = this._beziers[b[r][1]], o && _ && (o = o[i], _ = _[i], g = o.a + (o.b - o.a) * a, y = o.b + (o.c - o.b) * a, g += (y - g) * a, y += (o.c + (o.d - o.c) * a - y) * a, v = _.a + (_.b - _.a) * a, T = _.b + (_.c - _.b) * a, v += (T - v) * a, T += (_.c + (_.d - _.c) * a - T) * a, l = m ? Math.atan2(T - v, y - g) * x + w : this._initialRotations[r], p[s] ? d[s](l) : d[s] = l)
                            }
                        }
                    }),
                    _ = m.prototype;
                        ...
                        e._registerComplexSpecialProp("bezier", {
                            parser: function(t, e, s, o, a, l) {
                                ...
                                var h, u, c, f = e.values,
                                    ...
                                    _ = {};
                                if (0 > p) return a;
                                for (h = 0; p >= h; h++) c = i(t, f[h], o, a, l, p !== h), d[h] = c.end;
                                for (u in e) _[u] = e[u];
                                return _.values = d, a = new r(t, "bezier", 0, 0, c.pt, 2), a.data = c, a.plugin = l, a.setRatio = n, 0 === _.autoRotate && (_.autoRotate = !0), !_.autoRotate || _.autoRotate instanceof Array || (h = _.autoRotate === !0 ? 0 : Number(_.autoRotate), _.autoRotate = null != c.end.left ? [
                ...
                var u, c, f, p, d, m, _ = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                    ...
                    X = function() {
                        var t = B.indexOf("Android"),
                            e = F("a");
                        return f = -1 !== B.indexOf("Safari") && -1 === B.indexOf("Chrome") && (-1 === t || Number(B.substr(t + 8, 1)) > 3), d = f && 6 > Number(B.substr(B.indexOf("Version/") + 8, 1)), p = -1 !== B.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(B) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(B)) && (m = parseFloat(RegExp.$1)), e ? (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity)) : !1
                    }(),
                    Y = function(t) {
                    ...
                    V = function(t, e) {
                        ...
                        return n >= 0 ? (U = 3 === n ? "ms" : i[n], H = "-" + U.toLowerCase() + "-", U + t) : null
                    },
                    Q = D.defaultView ? D.defaultView.getComputedStyle : function() {},
                    G = o.getStyle = function(t, e, i, n, r) {
                        var s;
                        return X || "opacity" !== e ? (!n && t.style[e] ? s = t.style[e] : (i = i || Q(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(S, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]), null == r || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : r) : Y(t)
                    },
                    $ = W.convertToPixels = function(t, i, n, r, s) {
                        if ("px" === r || !r) return n;
                        if ("auto" === r || !n) return 0;
                        var a, l, h, u = R.test(i),
                            c = t,
                            f = N.style,
                            p = 0 > n;
                        if (p && (n = -n), "%" === r && -1 !== i.indexOf("border")) a = n / 100 * (u ? t.clientWidth : t.clientHeight);
                        else {
                            if (f.cssText = "border:0 solid red;position:" + G(t, "position") + ";line-height:0;", "%" !== r && c.appendChild) f[u ? "borderLeftWidth" : "borderTopWidth"] = n + r;
                            else {
                                if (c = t.parentNode || D.body, l = c._gsCache, h = e.ticker.frame, l && u && l.time === h) return l.width * n / 100;
                                f[u ? "width" : "height"] = n + r
                            }
                            c.appendChild(N), a = parseFloat(N[u ? "offsetWidth" : "offsetHeight"]), c.removeChild(N), u && "%" === r && o.cacheWidths !== !1 && (l = c._gsCache = c._gsCache || {}, l.time = h, l.width = 100 * (a / n)), 0 !== a || s || (a = $(t, i, n, r, !0))
                        }
                        return p ? -a : a
                    },
                    ...
                    J = function(t, e) {
                        ...
                        if (e = e || Q(t, null))
                            ...
                            for (i in e) "string" == typeof i && void 0 === r[i] && (r[i.replace(C, E)] = e[i]);
                        return X || (r.opacity = Y(t)), n = At(t, e, !1), r.rotation = n.rotation, r.skewX = n.skewX, r.scaleX = n.scaleX, r.scaleY = n.scaleY, r.x = n.x, r.y = n.y, St && (r.z = n.z, r.rotationX = n.rotationX, r.rotationY = n.rotationY, r.scaleZ = n.scaleZ), r.filters && delete r.filters, r
                    },
                    K = function(t, e, i, n, r) {
                        var s, o, a, l = {},
                            h = t.style;
                        for (o in i) "cssText" !== o && "length" !== o && isNaN(o) && (e[o] !== (s = i[o]) || r && r[o]) && -1 === o.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[o] = "auto" !== s || "left" !== o && "top" !== o ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[o] || "" === e[o].replace(y, "") ? s : 0 : Z(t, o), void 0 !== h[o] && (a = new pt(h, o, h[o], a)));
                        if (n)
                    ...
                    it = function(t, e, i) {
                        var n = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight),
                            r = tt[e],
                            s = r.length;
                        for (i = i || Q(t, null); --s > -1;) n -= parseFloat(G(t, "padding" + r[s], i, !0)) || 0, n -= parseFloat(G(t, "border" + r[s] + "Width", i, !0)) || 0;
                        return n
                    },
                    nt = function(t, e) {
                    ...
                    ot = function(t, e, i, n) {
                        ...
                        return null == t ? a = e : "number" == typeof t ? a = t : (r = 360, s = t.split("_"), l = "=" === t.charAt(1), o = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : L) - (l ? 0 : e), s.length && (n && (n[i] = e + o), -1 !== t.indexOf("short") && (o %= r, o !== o % (r / 2) && (o = 0 > o ? o + r : o - r)), -1 !== t.indexOf("_cw") && 0 > o ? o = (o + 9999999999 * r) % r - (0 | o / r) * r : -1 !== t.indexOf("ccw") && o > 0 && (o = (o - 9999999999 * r) % r - (0 | o / r) * r)), a = e + o), h > a && a > -h && (a = 0), a
                    },
                    at = {
                        aqua: [0, 255, 255],
                        lime: [0, 255, 0],
                ...
                var ct = function(t, e, i, n) {
                        ...
                        return u ? r = e ? function(t) {
                            ...
                            if ("number" == typeof t) t += c;
                                ...
                                for (d = t.replace(A, "|").split("|"), p = 0; d.length > p; p++) d[p] = r(d[p]);
                                return d.join(",")
                            }
                            if (e = (t.match(ut) || [s])[0], f = t.split(e).join("").match(v) || [], p = f.length, u > p--)
                                for (; u > ++p;) f[p] = i ? f[0 | (p - 1) / 2] : o[p];
                            return a + f.join(h) + h + e + l + (-1 !== t.indexOf("inset") ? " inset" : "")
                        } : function(t) {
                            var e, s, f;
                            if ("number" == typeof t) t += c;
                            else if (n && A.test(t)) {
                                for (s = t.replace(A, "|").split("|"), f = 0; s.length > f; f++) s[f] = r(s[f]);
                                return s.join(",")
                            }
                            if (e = t.match(v) || [], f = e.length, u > f--)
                                for (; u > ++f;) e[f] = i ? e[0 | (f - 1) / 2] : o[f];
                            return a + e.join(h) + l
                        } : function(t) {
                            return t
                        }
                    ...
                    pt = (W._setPluginRatio = function(t) {
                    ...
                    dt = (W._parseToProxy = function(t, e, i, n, r, s) {
                        var o, a, l, h, u, c = n,
                            ...
                            d = i._transform,
                            m = I;
                        for (i._transform = null, I = e, n = u = i.parse(t, e, n, r), I = m, s && (i._transform = d, c && (c._prev = null, c._prev && (c._prev._next = null))); n && n !== c;) {
                            if (1 >= n.type && (a = n.p, p[a] = n.s + n.c, f[a] = n.s, s || (h = new pt(n, "s", a, h, n.r), n.c = 0), 1 === n.type))
                                for (o = n.l; --o > 0;) l = "xn" + o, a = n.p + "_" + l, p[a] = n.data[l], f[a] = n[l], s || (h = new pt(n, l, a, h, n.rxp[l]));
                            n = n._next
                        }
                        return {
                            proxy: f,
                    ...
                    }, W.CSSPropTween = function(t, e, n, r, o, a, l, h, u, c, f) {
                        this.t = t, this.p = e, this.s = n, this.c = r, this.n = l || e, t instanceof dt || s.push(this.n), this.r = h, this.type = a || 0, u && (this.pr = u, i = !0), this.b = void 0 === c ? n : c, this.e = void 0 === f ? n + r : f, o && (this._next = o, o._prev = this)
                    }),
                    mt = o.parseComplex = function(t, e, i, n, r, s, o, a, l, h) {
                        i = i || s || "", o = new dt(t, e, 0, 0, o, h ? 2 : 1, null, !1, a, i, n), n += "";
                        var c, f, p, d, m, v, y, T, w, x, b, S, C = i.split(", ").join(",").split(" "),
                            O = n.split(", ").join(",").split(" "),
                            E = C.length,
                            R = u !== !1;
                        for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (C = C.join(" ").replace(A, ", ").split(" "), O = O.join(" ").replace(A, ", ").split(" "), E = C.length), E !== O.length && (C = (s || "").split(" "), E = C.length), o.plugin = l, o.setRatio = h, c = 0; E > c; c++)
                            if (d = C[c], m = O[c], T = parseFloat(d), T || 0 === T) o.appendXtra("", T, rt(m, T), m.replace(g, ""), R && -1 !== m.indexOf("px"), !0);
                            else if (r && ("#" === d.charAt(0) || at[d] || P.test(d))) S = "," === m.charAt(m.length - 1) ? ")," : ")", d = ht(d), m = ht(m), w = d.length + m.length > 6, w && !X && 0 === m[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent", o.e = o.e.split(O[c]).join("transparent")) : (X || (w = !1), o.appendXtra(w ? "rgba(" : "rgb(", d[0], m[0] - d[0], ",", !0, !0).appendXtra("", d[1], m[1] - d[1], ",", !0).appendXtra("", d[2], m[2] - d[2], w ? "," : S, !0), w && (d = 4 > d.length ? 1 : d[3], o.appendXtra("", d, (4 > m.length ? 1 : m[3]) - d, S, !1)));
                        else if (v = d.match(_)) {
                            if (y = m.match(g), !y || y.length !== v.length) return o;
                            for (p = 0, f = 0; v.length > f; f++) b = v[f], x = d.indexOf(b, p), o.appendXtra(d.substr(p, x - p), Number(b), rt(y[f], b), "", R && "px" === d.substr(x + b.length, 2), 0 === f), p = x + b.length;
                            o["xs" + o.l] += d.substr(p)
                    ...
                    _t = 9;
                for (h = dt.prototype, h.l = h.pr = 0; --_t > 0;) h["xn" + _t] = 0, h["xs" + _t] = "";
                        ...
                        if (!l[t]) {
                            ...
                            vt(t, {
                                parser: function(t, i, n, r, s, o, h) {
                                    ...
                                    return u ? (u._cssRegister(), l[n].parse(t, i, n, r, s, o, h)) : (q("Error: " + e + " js file not loaded."), s)
                                }
                            })
                        }
                    };
                h = gt.prototype, h.parseComplex = function(t, e, i, n, r, s) {
                    var o, a, l, h, u, c, f = this.keyword;
                    if (this.multi && (A.test(i) || A.test(e) ? (a = e.replace(A, "|").split("|"), l = i.replace(A, "|").split("|")) : f && (a = [e], l = [i])), l) {
                        for (h = l.length > a.length ? l.length : a.length, o = 0; h > o; o++) e = a[o] = a[o] || this.dflt, i = l[o] = l[o] || this.dflt, f && (u = e.indexOf(f), c = i.indexOf(f), u !== c && (i = -1 === c ? l : a, i[o] += " " + f));
                        e = a.join(", "), i = l.join(", ")
                    }
                ...
                var Tt, wt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    kt = function() {
                        ...
                        return D.createElementNS && !n && (t = Et("svg", Rt), e = Et("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        }), i = e.getBoundingClientRect().width, e.style[Pt] = "50% 50%", e.style[xt] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(p && St), Rt.removeChild(t)), n
                    }(),
                    zt = function(t, e, i) {
                        var n = t.getBBox();
                    ...
                    At = W.getTransform = function(t, e, i, n) {
                        ...
                        var s, a, l, h, u, c, f, p, d, m, _ = i ? t._gsTransform || new Ct : new Ct,
                            g = 0 > _.scaleX,
                            v = 2e-5,
                            y = 1e5,
                            T = St ? parseFloat(G(t, Pt, e, !1, "0 0 0").split(" ")[2]) || _.zOrigin || 0 : 0,
                            w = parseFloat(o.defaultTransformPerspective) || 0;
                        if (xt ? a = G(t, bt, e, !0) : t.currentStyle && (a = t.currentStyle.filter.match(k), a = a && 4 === a.length ? [a[0].substr(4), Number(a[2].substr(4)), Number(a[1].substr(4)), a[3].substr(4), _.x || 0, _.y || 0].join(",") : ""), s = !a || "none" === a || "matrix(1, 0, 0, 1, 0, 0)" === a, _.svg = !!(Ot && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM)), _.svg && (zt(t, G(t, Pt, r, !1, "50% 50%") + "", _), Tt = o.useSVGTransformAttr || kt, l = t.getAttribute("transform"), s && l && -1 !== l.indexOf("matrix") && (a = l, s = 0)), !s) {
                            for (l = (a || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], h = l.length; --h > -1;) u = Number(l[h]), l[h] = (c = u - (u |= 0)) ? (0 | c * y + (0 > c ? -.5 : .5)) / y + u : u;
                            if (16 === l.length) {
                                var x, b, P, S, C, O = l[0],
                                    E = l[1],
                                    R = l[2],
                                    ...
                                    Y = l[11],
                                    q = Math.atan2(I, j);
                                _.zOrigin && (X = -_.zOrigin, W = F * X - l[12], B = N * X - l[13], X = j * X + _.zOrigin - l[14]), _.rotationX = q * L, q && (S = Math.cos(-q), C = Math.sin(-q), x = A * S + F * C, b = M * S + N * C, P = I * S + j * C, F = A * -C + F * S, N = M * -C + N * S, j = I * -C + j * S, Y = D * -C + Y * S, A = x, M = b, I = P), q = Math.atan2(F, j), _.rotationY = q * L, q && (S = Math.cos(-q), C = Math.sin(-q), x = O * S - F * C, b = E * S - N * C, P = R * S - j * C, N = E * C + N * S, j = R * C + j * S, Y = z * C + Y * S, O = x, E = b, R = P), q = Math.atan2(E, O), _.rotation = q * L, q && (S = Math.cos(-q), C = Math.sin(-q), O = O * S + A * C, b = E * S + M * C, M = E * -C + M * S, I = R * -C + I * S, E = b), _.rotationX && Math.abs(_.rotationX) + Math.abs(_.rotation) > 359.9 && (_.rotationX = _.rotation = 0, _.rotationY += 180), _.scaleX = (0 | Math.sqrt(O * O + E * E) * y + .5) / y, _.scaleY = (0 | Math.sqrt(M * M + N * N) * y + .5) / y, _.scaleZ = (0 | Math.sqrt(I * I + j * j) * y + .5) / y, _.skewX = 0, _.perspective = Y ? 1 / (0 > Y ? -Y : Y) : 0, _.x = W, _.y = B, _.z = X
                                ...
                                var H = l.length >= 6,
                                    ...
                                    Q = l[2] || 0,
                                    $ = H ? l[3] : 1;
                                _.x = l[4] || 0, _.y = l[5] || 0, f = Math.sqrt(U * U + V * V), p = Math.sqrt($ * $ + Q * Q), d = U || V ? Math.atan2(V, U) * L : _.rotation || 0, m = Q || $ ? Math.atan2(Q, $) * L + d : _.skewX || 0, Math.abs(m) > 90 && 270 > Math.abs(m) && (g ? (f *= -1, m += 0 >= d ? 180 : -180, d += 0 >= d ? 180 : -180) : (p *= -1, m += 0 >= m ? 180 : -180)), _.scaleX = f, _.scaleY = p, _.rotation = d, _.skewX = m, St && (_.rotationX = _.rotationY = _.z = 0, _.perspective = w, _.scaleZ = 1)
                            }
                            _.zOrigin = T;
                            for (h in _) v > _[h] && _[h] > -v && (_[h] = 0)
                        }
                    ...
                    Mt = function(t) {
                        ...
                        if (f) {
                            ...
                            if (null != n.ox && (p = (n.oxp ? .01 * _ * n.ox : n.ox) - _ / 2, d = (n.oyp ? .01 * g * n.oy : n.oy) - g / 2, x += p - (p * a + d * l), b += d - (p * h + d * u)), v ? (p = _ / 2, d = g / 2, y += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * h + d * u) + b) + ")") : y += ", sizingMethod='auto expand')", c.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(z, y) : y + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === h && 1 === u && (v && -1 === y.indexOf("Dx=0, Dy=0") || w.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && c.removeAttribute("filter")), !v) {
                                var P, S, C, O = 8 > m ? 1 : -1;
                                for (p = n.ieOffsetX || 0, d = n.ieOffsetY || 0, n.ieOffsetX = Math.round((_ - ((0 > a ? -a : a) * _ + (0 > l ? -l : l) * g)) / 2 + x), n.ieOffsetY = Math.round((g - ((0 > u ? -u : u) * g + (0 > h ? -h : h) * _)) / 2 + b), _t = 0; 4 > _t; _t++) S = et[_t], P = f[S], i = -1 !== P.indexOf("px") ? parseFloat(P) : $(this.t, S, parseFloat(P), P.replace(T, "")) || 0, C = i !== n[S] ? 2 > _t ? -n.ieOffsetX : -n.ieOffsetY : 2 > _t ? p - n.ieOffsetX : d - n.ieOffsetY, c[S] = (n[S] = Math.round(i - C * (0 === _t || 2 === _t ? 1 : O))) + "px"
                            }
                        }
                    },
                    Lt = W.set3DTransformRatio = function(t) {
                        var e, i, n, r, s, o, a, l, h, u, c, f, d, m, _, g, v, y, T, w, x, b = this.data,
                            P = this.t.style,
                            S = b.rotation * M,
                            C = b.scaleX,
                            O = b.scaleY,
                            ...
                            z = b.z,
                            A = b.perspective;
                        if (!(1 !== t && 0 !== t && b.force3D || b.force3D === !0 || b.rotationY || b.rotationX || 1 !== E || A || z)) return void It.call(this, t);
                        if (p && (m = 1e-4, m > C && C > -m && (C = E = 2e-5), m > O && O > -m && (O = E = 2e-5), !A || b.z || b.rotationX || b.rotationY || (A = 0)), S || b.skewX) _ = e = Math.cos(S), g = r = Math.sin(S), b.skewX && (S -= b.skewX * M, _ = Math.cos(S), g = Math.sin(S), "simple" === b.skewType && (v = Math.tan(b.skewX * M), v = Math.sqrt(1 + v * v), _ *= v, g *= v)), i = -g, s = _;
                        else {
                            if (!(b.rotationY || b.rotationX || 1 !== E || A || b.svg)) return void(P[xt] = (b.xPercent || b.yPercent ? "translate(" + b.xPercent + "%," + b.yPercent + "%) translate3d(" : "translate3d(") + R + "px," + k + "px," + z + "px)" + (1 !== C || 1 !== O ? " scale(" + C + "," + O + ")" : ""));
                            e = s = 1, i = r = 0
                        }
                        h = 1, n = o = a = l = u = c = 0, f = A ? -1 / A : 0, d = b.zOrigin, m = 1e-6, w = ",", x = "0", S = b.rotationY * M, S && (_ = Math.cos(S), g = Math.sin(S), a = -g, u = f * -g, n = e * g, o = r * g, h = _, f *= _, e *= _, r *= _), S = b.rotationX * M, S && (_ = Math.cos(S), g = Math.sin(S), v = i * _ + n * g, y = s * _ + o * g, l = h * g, c = f * g, n = i * -g + n * _, o = s * -g + o * _, h *= _, f *= _, i = v, s = y), 1 !== E && (n *= E, o *= E, h *= E, f *= E), 1 !== O && (i *= O, s *= O, l *= O, c *= O), 1 !== C && (e *= C, r *= C, a *= C, u *= C), (d || b.svg) && (d && (R += n * -d, k += o * -d, z += h * -d + d), b.svg && (R += b.xOrigin - (b.xOrigin * e + b.yOrigin * i), k += b.yOrigin - (b.xOrigin * r + b.yOrigin * s)), m > R && R > -m && (R = x), m > k && k > -m && (k = x), m > z && z > -m && (z = 0)), T = b.xPercent || b.yPercent ? "translate(" + b.xPercent + "%," + b.yPercent + "%) matrix3d(" : "matrix3d(", T += (m > e && e > -m ? x : e) + w + (m > r && r > -m ? x : r) + w + (m > a && a > -m ? x : a), T += w + (m > u && u > -m ? x : u) + w + (m > i && i > -m ? x : i) + w + (m > s && s > -m ? x : s), b.rotationX || b.rotationY ? (T += w + (m > l && l > -m ? x : l) + w + (m > c && c > -m ? x : c) + w + (m > n && n > -m ? x : n), T += w + (m > o && o > -m ? x : o) + w + (m > h && h > -m ? x : h) + w + (m > f && f > -m ? x : f) + w) : T += ",0,0,0,0,1,0,", T += R + w + k + w + z + w + (A ? 1 + -z / A : 1) + ")", P[xt] = T
                    },
                    It = W.set2DTransformRatio = function(t) {
                        var e, i, n, r, s, o, a, l, h, u, c, f = this.data,
                            p = this.t,
                            d = p.style,
                            m = f.x,
                            _ = f.y;
                        return !(f.rotationX || f.rotationY || f.z || f.force3D === !0 || "auto" === f.force3D && 1 !== t && 0 !== t) || f.svg && Tt || !St ? (r = f.scaleX, s = f.scaleY, void(f.rotation || f.skewX || f.svg ? (e = f.rotation * M, i = e - f.skewX * M, n = 1e5, o = Math.cos(e) * r, a = Math.sin(e) * r, l = Math.sin(i) * -s, h = Math.cos(i) * s, f.svg && (m += f.xOrigin - (f.xOrigin * o + f.yOrigin * l), _ += f.yOrigin - (f.xOrigin * a + f.yOrigin * h), c = 1e-6, c > m && m > -c && (m = 0), c > _ && _ > -c && (_ = 0)), u = (0 | o * n) / n + "," + (0 | a * n) / n + "," + (0 | l * n) / n + "," + (0 | h * n) / n + "," + m + "," + _ + ")", f.svg && Tt ? p.setAttribute("transform", "matrix(" + u) : d[xt] = (f.xPercent || f.yPercent ? "translate(" + f.xPercent + "%," + f.yPercent + "%) matrix(" : "matrix(") + u) : d[xt] = (f.xPercent || f.yPercent ? "translate(" + f.xPercent + "%," + f.yPercent + "%) matrix(" : "matrix(") + r + ",0,0," + s + "," + m + "," + _ + ")")) : (this.setRatio = Lt, void Lt.call(this, t))
                    };
                h = Ct.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = 0, h.scaleX = h.scaleY = h.scaleZ = 1, vt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                    parser: function(t, e, i, n, s, a, l) {
                        ...
                        var h, u, c, f, p, d, m, _ = n._transform = At(t, r, !0, l.parseTransform),
                            g = t.style,
                            v = 1e-6,
                            y = wt.length,
                            T = l,
                            w = {};
                        if ("string" == typeof T.transform && xt) c = N.style, c[xt] = T.transform, c.display = "block", c.position = "absolute", D.body.appendChild(N), h = At(N, null, !1), D.body.removeChild(N);
                            ...
                            "string" == typeof T.x && -1 !== T.x.indexOf("%") && (h.x = 0, h.xPercent = st(T.x, _.xPercent)), "string" == typeof T.y && -1 !== T.y.indexOf("%") && (h.y = 0, h.yPercent = st(T.y, _.yPercent)), h.rotation = ot("rotation" in T ? T.rotation : "shortRotation" in T ? T.shortRotation + "_short" : "rotationZ" in T ? T.rotationZ : _.rotation, _.rotation, "rotation", w), St && (h.rotationX = ot("rotationX" in T ? T.rotationX : "shortRotationX" in T ? T.shortRotationX + "_short" : _.rotationX || 0, _.rotationX, "rotationX", w), h.rotationY = ot("rotationY" in T ? T.rotationY : "shortRotationY" in T ? T.shortRotationY + "_short" : _.rotationY || 0, _.rotationY, "rotationY", w)), h.skewX = null == T.skewX ? _.skewX : ot(T.skewX, _.skewX), h.skewY = null == T.skewY ? _.skewY : ot(T.skewY, _.skewY), (u = h.skewY - _.skewY) && (h.skewX += u, h.rotation += u)
                        }
                        for (St && null != T.force3D && (_.force3D = T.force3D, d = !0), _.skewType = T.skewType || _.skewType || o.defaultSkewType, p = _.force3D || _.z || _.rotationX || _.rotationY || h.z || h.rotationX || h.rotationY || h.perspective, p || null == T.scale || (h.scaleZ = 1); --y > -1;) i = wt[y], f = h[i] - _[i], (f > v || -v > f || null != T[i] || null != I[i]) && (d = !0, s = new dt(_, i, _[i], f, s), i in w && (s.e = w[i]), s.xs0 = 0, s.plugin = a, n._overwriteProps.push(s.n));
                        return f = T.transformOrigin, f && _.svg && (zt(t, nt(f), h), s = new dt(_, "xOrigin", _.xOrigin, h.xOrigin - _.xOrigin, s, -1, "transformOrigin"), s.b = _.xOrigin, s.e = s.xs0 = h.xOrigin, s = new dt(_, "yOrigin", _.yOrigin, h.yOrigin - _.yOrigin, s, -1, "transformOrigin"), s.b = _.yOrigin, s.e = s.xs0 = h.yOrigin, f = "0px 0px"), (f || St && p && _.zOrigin) && (xt ? (d = !0, i = Pt, f = (f || G(t, i, r, !1, "50% 50%")) + "", s = new dt(g, i, 0, 0, s, -1, "transformOrigin"), s.b = g[i], s.plugin = a, St ? (c = _.zOrigin, f = f.split(" "), _.zOrigin = (f.length > 2 && (0 === c || "0px" !== f[2]) ? parseFloat(f[2]) : c) || 0, s.xs0 = s.e = f[0] + " " + (f[1] || "50%") + " 0px", s = new dt(_, "zOrigin", 0, 0, s, -1, s.n), s.b = c, s.xs0 = s.e = _.zOrigin) : s.xs0 = s.e = f) : nt(f + "", _)), d && (n._transformType = _.svg && Tt || !p && 3 !== this._transformType ? 2 : 3), s
                    },
                    prefix: !0
                }), vt("boxShadow", {
                    ...
                    parser: function(t, e, i, s, o) {
                        e = this.format(e);
                        var a, l, h, u, c, f, p, d, m, _, g, v, y, T, w, x, b = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                            P = t.style;
                        for (m = parseFloat(t.offsetWidth), _ = parseFloat(t.offsetHeight), a = e.split(" "), l = 0; b.length > l; l++) this.p.indexOf("border") && (b[l] = V(b[l])), c = u = G(t, b[l], r, !1, "0px"), -1 !== c.indexOf(" ") && (u = c.split(" "), c = u[0], u = u[1]), f = h = a[l], p = parseFloat(c), v = c.substr((p + "").length), y = "=" === f.charAt(1), y ? (d = parseInt(f.charAt(0) + "1", 10), f = f.substr(2), d *= parseFloat(f), g = f.substr((d + "").length - (0 > d ? 1 : 0)) || "") : (d = parseFloat(f), g = f.substr((d + "").length)), "" === g && (g = n[i] || v), g !== v && (T = $(t, "borderLeft", p, v), w = $(t, "borderTop", p, v), "%" === g ? (c = 100 * (T / m) + "%", u = 100 * (w / _) + "%") : "em" === g ? (x = $(t, "borderLeft", 1, "em"), c = T / x + "em", u = w / x + "em") : (c = T + "px", u = w + "px"), y && (f = parseFloat(c) + d + g, h = parseFloat(u) + d + g)), o = mt(P, b[l], c + " " + u, f + " " + h, !1, "0px", o);
                        return o
                    },
                    prefix: !0,
                    ...
                    parser: function(t, e, i, n, s, o) {
                        var a, l, h, u, c, f, p = "background-position",
                            ...
                            g = this.format(e);
                        if (-1 !== _.indexOf("%") != (-1 !== g.indexOf("%")) && (f = G(t, "backgroundImage").replace(O, ""), f && "none" !== f)) {
                            for (a = _.split(" "), l = g.split(" "), j.setAttribute("src", f), h = 2; --h > -1;) _ = a[h], u = -1 !== _.indexOf("%"), u !== (-1 !== l[h].indexOf("%")) && (c = 0 === h ? t.offsetWidth - j.width : t.offsetHeight - j.height, a[h] = u ? parseFloat(_) / 100 * c + "px" : 100 * (parseFloat(_) / c) + "%");
                            _ = a.join(" ")
                        }
                ...
                vt("opacity,alpha,autoAlpha", {
                    ...
                    parser: function(t, e, i, n, s, o) {
                        var a = parseFloat(G(t, "opacity", r, !1, "1")),
                            l = t.style,
                            h = "autoAlpha" === i;
                        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + a), h && 1 === a && "hidden" === G(t, "visibility", r) && 0 !== e && (a = 0), X ? s = new dt(l, "opacity", a, e - a, s) : (s = new dt(l, "opacity", 100 * a, 100 * (e - a), s), s.xn1 = h ? 1 : 0, l.zoom = 1, s.type = 2, s.b = "alpha(opacity=" + s.s + ")", s.e = "alpha(opacity=" + (s.s + s.c) + ")", s.data = t, s.plugin = o, s.setRatio = Dt), h && (s = new dt(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit"), s.xs0 = "inherit", n._overwriteProps.push(s.n), n._overwriteProps.push(i)), s
                    }
                });
                var Ft = function(t, e) {
                ...
                vt("className", {
                    parser: function(t, e, n, s, o, a, l) {
                        var h, u, c, f, p, d = t.getAttribute("class") || "",
                            m = t.style.cssText;
                        if (o = s._classNamePT = new dt(t, n, 0, 0, o, 2), o.setRatio = Nt, o.pr = -11, i = !0, o.b = d, u = J(t, r), c = t._gsClassPT) {
                            for (f = {}, p = c.data; p;) f[p.p] = 1, p = p._next;
                            c.setRatio(1)
                        }
                        return t._gsClassPT = o, o.e = "=" !== e.charAt(1) ? e : d.replace(RegExp("\\s*\\b" + e.substr(2) + "\\b"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), s._tween._duration && (t.setAttribute("class", o.e), h = K(t, u, J(t), l, f), t.setAttribute("class", d), o.data = h.firstMPT, t.style.cssText = m, o = o.xfirst = s.parse(t, h.difs, o, a)), o
                    }
                });
                var jt = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) s.cssText = "", r = !0;
                            ...
                            for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1;) i = e[n], l[i] && (l[i].parse === o ? r = !0 : i = "transformOrigin" === i ? Pt : l[i].p), Ft(s, i);
                        r && (Ft(s, xt), this.t._gsTransform && delete this.t._gsTransform)
                    }
                };
                for (vt("clearProps", {
                        parser: function(t, e, n, r, s) {
                            return s = new dt(t, n, 0, 0, s, 2), s.setRatio = jt, s.e = e, s.pr = -10, s.data = r._tween, i = !0, s
                        }
                    }), h = "bezier,throwProps,physicsProps,physics2D".split(","),
                    _t = h.length; _t--;) yt(h[_t]);
                h = o.prototype, h._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a) {
                    if (!t.nodeType) return !1;
                    this._target = t, this._tween = a, this._vars = e, u = e.autoRound, i = !1, n = e.suffixMap || o.suffixMap, r = Q(t, ""), s = this._overwriteProps;
                    var l, h, p, m, _, g, v, y, T, w = t.style;
                    if (c && "" === w.zIndex && (l = G(t, "zIndex", r), ("auto" === l || "" === l) && this._addLazySet(w, "zIndex", 0)), "string" == typeof e && (m = w.cssText, l = J(t, r), w.cssText = m + ";" + e, l = K(t, l, J(t)).difs, !X && x.test(e) && (l.opacity = parseFloat(RegExp.$1)), e = l, w.cssText = m), this._firstPT = h = this.parse(t, e, null), this._transformType) {
                        for (T = 3 === this._transformType, xt ? f && (c = !0, "" === w.zIndex && (v = G(t, "zIndex", r), ("auto" === v || "" === v) && this._addLazySet(w, "zIndex", 0)), d && this._addLazySet(w, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden"))) : w.zoom = 1, p = h; p && p._next;) p = p._next;
                        y = new dt(t, "transform", 0, 0, null, 2), this._linkCSSP(y, null, p), y.setRatio = T && St ? Lt : xt ? It : Mt, y.data = this._transform || At(t, r, !0), s.pop()
                    }
                    if (i) {
                        for (; h;) {
                            for (g = h._next, p = m; p && p.pr > h.pr;) p = p._next;
                            (h._prev = p ? p._prev : _) ? h._prev._next = h: m = h, (h._next = p) ? p._prev = h : _ = h, h = g
                        }
                        this._firstPT = m
                    }
                    return !0
                }, h.parse = function(t, e, i, s) {
                    var o, a, h, c, f, p, d, m, _, g, v = t.style;
                    for (o in e) p = e[o], a = l[o], a ? i = a.parse(t, p, o, this, i, s, e) : (f = G(t, o, r) + "", _ = "string" == typeof p, "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || _ && P.test(p) ? (_ || (p = ht(p), p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"), i = mt(v, o, f, p, !0, "transparent", i, 0, s)) : !_ || -1 === p.indexOf(" ") && -1 === p.indexOf(",") ? (h = parseFloat(f), d = h || 0 === h ? f.substr((h + "").length) : "", ("" === f || "auto" === f) && ("width" === o || "height" === o ? (h = it(t, o, r), d = "px") : "left" === o || "top" === o ? (h = Z(t, o, r), d = "px") : (h = "opacity" !== o ? 0 : 1, d = "")), g = _ && "=" === p.charAt(1), g ? (c = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), c *= parseFloat(p), m = p.replace(T, "")) : (c = parseFloat(p), m = _ ? p.replace(T, "") : ""), "" === m && (m = o in n ? n[o] : d), p = c || 0 === c ? (g ? c + h : c) + m : e[o], d !== m && "" !== m && (c || 0 === c) && h && (h = $(t, o, h, d), "%" === m ? (h /= $(t, o, 100, "%") / 100, e.strictUnits !== !0 && (f = h + "%")) : "em" === m ? h /= $(t, o, 1, "em") : "px" !== m && (c = $(t, o, c, m), m = "px"), g && (c || 0 === c) && (p = c + h + m)), g && (c += h), !h && 0 !== h || !c && 0 !== c ? void 0 !== v[o] && (p || "NaN" != p + "" && null != p) ? (i = new dt(v, o, c || h || 0, 0, i, -1, o, !1, 0, f, p), i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : f) : q("invalid " + o + " tween value: " + e[o]) : (i = new dt(v, o, h, c - h, i, 0, o, u !== !1 && ("px" === m || "zIndex" === o), 0, f, p), i.xs0 = m)) : i = mt(v, o, f, p, !0, null, i, 0, s)), s && i && !i.plugin && (i.plugin = s);
                    return i
                    ...
                    this._transform = this._transform || At(this._target, r, !0), this._transformType = this._transform.svg && Tt || !t && 3 !== this._transformType ? 2 : 3
                };
                var Wt = function() {
                ...
                var Bt = function(t, e, i) {
                    var n, r, s, o;
                    if (t.slice)
                        for (r = t.length; --r > -1;) Bt(t[r], e, i);
                    else
                        for (n = t.childNodes, r = n.length; --r > -1;) s = n[r], o = s.type, s.style && (e.push(J(s)), i && i.push(s)), 1 !== o && 9 !== o && 11 !== o || !s.childNodes.length || Bt(s, e, i)
                };
                return o.cascadeTo = function(t, i, n) {
                    ...
                    for (t = a._targets || a.target, Bt(t, h, c), a.render(i, !0), Bt(t, u), a.render(0, !0), a._enabled(!0), r = c.length; --r > -1;)
                        if (s = K(c[r], h[r], u[r]), s.firstMPT) {
                            s = s.difs;
    ...
    function(t, e) {
        ...
        if (!i.TweenLite) {
            var n, r, s, o, a, l = function(t) {
                ...
                m = function(n, r, s, o) {
                    ...
                    this.check = function(h) {
                        for (var u, c, f, p, _ = r.length, g = _; --_ > -1;)(u = d[r[_]] || new m(r[_], [])).gsClass ? (a[_] = u.gsClass, g--) : h && u.sc.push(this);
                        if (0 === g && s)
                            for (c = ("com.greensock." + n).split("."), f = c.pop(), p = l(c.join("."))[f] = this.gsClass = s.apply(s, a), o && (i[f] = p, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + n.split(".").pop(), [], function() {
                                    return p
                                }) : n === e && "undefined" != typeof module && module.exports && (module.exports = p)), _ = 0; this.sc.length > _; _++) this.sc[_].check()
                    }, this.check(!0)
                },
            ...
            var v = [0, 0, 1, 1],
                ...
                x = T.register = function(t, e, i, n) {
                    for (var r, s, o, a, l = e.split(","), u = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); --u > -1;)
                        for (s = l[u], r = n ? g("easing." + s, null, !0) : h.easing[s] || {}, o = c.length; --o > -1;) a = c[o], w[s + "." + a] = w[a + s] = r[a] = t.getRatio ? t : t[a] || new t
                };
            for (s = T.prototype, s._calcEnd = !1, s.getRatio = function(t) {
                ...
                }, n = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"], r = n.length; --r > -1;) s = n[r] + ",Power" + r, x(new T(null, null, 1, r), s, "easeOut", !0), x(new T(null, null, 2, r), s, "easeIn" + (0 === r ? ",easeNone" : "")), x(new T(null, null, 3, r), s, "easeInOut");
            ...
            g("Ticker", function(t, e) {
                var i, n, r, s, l, h = this,
                    ...
                    g = function(t) {
                        var e, o, a = C() - O;
                        a > d && (c += a - m), O += a, h.time = (O - c) / 1e3, e = h.time - l, (!i || e > 0 || t === !0) && (h.frame++, l += e + (e >= s ? .004 : s - e), o = !0), t !== !0 && (r = n(g)), o && h.dispatchEvent(_)
                    };
                b.call(h), h.time = h.frame = 0, h.tick = function() {
                    ...
                    null != r && (p && S ? S(r) : clearTimeout(r), n = f, r = null, h === o && (a = !1))
                }, h.wake = function() {
                    null !== r ? h.sleep() : h.frame > 10 && (O = C() - d + 5), n = 0 === i ? f : p && P ? P : function(t) {
            ...
            var R = function() {
                a && C() - O > 2e3 && o.wake(), setTimeout(R, 2e3)
            };
            ...
            var z = g("TweenLite", function(e, i, n) {
                    ...
                    if (this._overwrite = l = null == l ? B[z.defaultOverwrite] : "number" == typeof l ? l >> 0 : B[l], (a || e instanceof Array || e.push && p(e)) && "number" != typeof e[0])
                ...
                M = function(t, e) {
                    var i, n = {};
                    for (i in t) W[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!F[i] || F[i] && F[i]._autoCSS) || (n[i] = t[i], delete t[i]);
                    t.css = n
                };
            s = z.prototype = new E, s.constructor = z, s.kill()._gc = !1, s.ratio = 0, s._firstPT = s._targets = s._overwrittenProps = s._startAt = null, s._notifyPluginsOfEnabled = s._lazy = !1, z.version = "1.15.1", z.defaultEase = s._ease = new T(null, null, 1, 1), z.defaultOverwrite = "auto", z.ticker = o, z.autoSleep = !0, z.lagSmoothing = function(t, e) {
                o.lagSmoothing(t, e)
            ...
            Y._startTime = o.time, X._startTime = o.frame, Y._active = X._active = !0, setTimeout(q, 1), E._updateRoot = z.render = function() {
                var t, e, i;
                if (L.length && q(), Y.render((o.time - Y._startTime) * Y._timeScale, !1, !1), X.render((o.frame - X._startTime) * X._timeScale, !1, !1), L.length && q(), !(o.frame % 120)) {
                    for (i in N) {
                        for (e = N[i].tweens, t = e.length; --t > -1;) e[t]._gc && e.splice(t, 1);
                        0 === e.length && delete N[i]
                    }
                    if (i = Y._first, (!i || i._paused) && z.autoSleep && !X._first && 1 === o._listeners.tick.length) {
            ...
            var H = function(t, e, i) {
                ...
                V = function(t, e, i, n, r) {
                    ...
                    var h, c = e._startTime + u,
                        ...
                        p = 0,
                        d = 0 === e._duration;
                    for (s = r.length; --s > -1;)(a = r[s]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (h = h || Q(e, 0, d), 0 === Q(a, h, d) && (f[p++] = a)) : c >= a._startTime && a._startTime + a.totalDuration() / a._timeScale > c && ((d || !a._initted) && 2e-10 >= c - a._startTime || (f[p++] = a)));
                    for (s = p; --s > -1;)
            ...
            s._init = function() {
                ...
                if (this._ease = h = h ? h instanceof T ? h : "function" == typeof h ? new T(h, s.easeParams) : w[h] || z.defaultEase : z.defaultEase, s.easeParams instanceof Array && h.config && (this._ease = h.config.apply(h, s.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
                ...
                var s, o, a, l, h, u;
                if (null == e) return !1;
                I[e._gsTweenID] && q(), this.vars.css || e.style && e !== t && e.nodeType && F.css && this.vars.autoCSS !== !1 && M(this.vars, e);
                for (s in this.vars) {
                    if (u = this.vars[s], W[s]) u && (u instanceof Array || u.push && p(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[s] = u = this._swapSelfInParams(u, this));
                ...
                return r && this._kill(r, e) ? this._initProps(e, i, n, r) : this._overwrite > 1 && this._firstPT && n.length > 1 && V(e, this, i, this._overwrite, n) ? (this._kill(i, e), this._initProps(e, i, n, r)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (I[e._gsTweenID] = !0), a)
            }, s.render = function(t, e, i) {
                var n, r, s, o, a = this._time,
                    l = this._duration,
                    h = this._rawPrevTime;
                if (t >= l) this._totalTime = this._time = l, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (n = !0, r = "onComplete"), 0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > h || h === u && "isPause" !== this.data) && h !== t && (i = !0, h > u && (r = "onReverseComplete")), this._rawPrevTime = o = !e || t || h === t ? t : u);
                else if (1e-7 > t) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== a || 0 === l && h > 0 && h !== u) && (r = "onReverseComplete", n = this._reversed), 0 > t && (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (h >= 0 && (h !== u || "isPause" !== this.data) && (i = !0), this._rawPrevTime = o = !e || t || h === t ? t : u)), this._initted || (i = !0);
                ...
                if (this._time !== a || i) {
                    ...
                    this._onUpdate && (0 > t && this._startAt && t !== -1e-4 && this._startAt.render(t, e, i), e || (this._time !== a || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || y)), r && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && t !== -1e-4 && this._startAt.render(t, e, i), n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                        this._active = !1), !e && this.vars[r] && this.vars[r].apply(this.vars[r + "Scope"] || this, this.vars[r + "Params"] || y), 0 === l && this._rawPrevTime === u && o !== u && (this._rawPrevTime = 0))
                }
                ...
                if ((p(e) || A(e)) && "number" != typeof e[0])
                    ...
                    if (a) {
                        ...
                        for (s in h)(o = a[s]) && (o.pg && o.t._kill(h) && (l = !0), o.pg && 0 !== o.t._overwriteProps.length || (o._prev ? o._prev._next = o._next : o === this._firstPT && (this._firstPT = o._next), o._next && (o._next._prev = o._prev), o._next = o._prev = null), delete a[s]), u && (r[s] = 1);
                ...
                return E.prototype._enabled.call(this, t, e), this._notifyPluginsOfEnabled && this._firstPT ? z._onPluginEvent(t ? "_onEnable" : "_onDisable", this) : !1
            }, z.to = function(t, e, i) {
                return new z(t, e, i)
            ...
            if (s = G.prototype, G.version = "1.10.1", G.API = 2, s._firstPT = null, s._addTween = function(t, e, i, n, r, s) {
                    ...
                    for (var e = t.length; --e > -1;) t[e].API === G.API && (F[(new t[e])._propName] = t[e]);
                    return !0
                }, _.plugin = function(t) {
        ...
        t.Controller = function(n) {
            var s, o, a = "ScrollMagic.Controller",
                ...
                w = function() {
                    ...
                    v = p.container === window || p.container === document.body || !document.body.contains(p.container), v && (p.container = window), y = P(), p.container.addEventListener("resize", E), p.container.addEventListener("scroll", E), p.refreshInterval = parseInt(p.refreshInterval) || c.refreshInterval, x()
                },
                x = function() {
                ...
                E = function(t) {
                    "resize" == t.type && (y = P(), g = u), m !== !0 && (m = !0, O())
                },
                R = function() {
                    if (!v && y != P()) {
                        var t;
            ...
            return this.addScene = function(e) {
                if (r.type.Array(e)) e.forEach(function(t) {
                    ...
                    d.push(e), d = k(d), e.on("shift.controller_sort", function() {
                        d = k(d)
                    });
                ...
                return r.type.Array(e) ? e.forEach(function(t) {
                    f.updateScene(t, i)
                }) : i ? e.update(!0) : m !== !0 && e instanceof t.Scene && (m = m || [], -1 == m.indexOf(e) && m.push(e), m = k(m), O()), f
                ...
                return arguments.length ? (r.type.Function(t) && (b = t), f) : b.call(f)
                ...
                return arguments.length ? (T != t && (T = !!t, f.updateScene(d, !0)), f) : T
        ...
        t.Controller.addOption = function(t, e) {
            ...
            this.on = function(t, e) {
                ...
                return e instanceof t.Controller && o != e && (o && o.removeScene(c), o = e, S(), w(!0), x(!0), T(), o.info("container").addEventListener("resize", b), e.addScene(c), c.trigger("add", {
                    controller: o
                }), c.update()), c
            }, this.enabled = function(t) {
                ...
                if (o)
                    if (t)
                        if (o.enabled() && g) {
                            ...
                            e = f.duration > 0 ? (i - m.start) / (m.end - m.start) : i >= m.start ? 1 : 0, c.trigger("update", {
                                startPos: m.start,
                                endPos: m.end,
                                scrollPos: i
                            }), c.progress(e)
                ...
                if (arguments.length) {
                    var e = !1,
                        ...
                        r = f.reverse || t >= d;
                    if (0 === f.duration ? (e = d != t, d = 1 > t && r ? 0 : 1, p = 0 === d ? a : l) : 0 > t && p !== a && r ? (d = 0, p = a, e = !0) : t >= 0 && 1 > t && r ? (d = t, p = l, e = !0) : t >= 1 && p !== h ? (d = 1, p = h, e = !0) : p !== l || r || k(), e) {
                        var s = {
                                progress: d,
                                state: p,
                                scrollDirection: n
            ...
            var T = function() {
                ...
                O = function(t) {
                    c[t] || (c[t] = function(e) {
                        return arguments.length ? ("duration" === t && (s = void 0), C(t, e) && (c.trigger("change", {
                            what: t,
                            newval: f[t]
            ...
            this.controller = function() {
                ...
                var t = f.offset;
                return o && (t += f.triggerElement ? _ : o.info("size") * c.triggerHook()), t
            };
            var E, R;
            c.on("shift.internal", function(t) {
                var e = "duration" === t.reason;
                (p === h && e || p === l && 0 === f.duration) && k(), e && z()
            ...
            var k = function(t) {
                    if (E && o) {
                        ...
                        if (t || p !== l) {
                            ...
                            R.pushFollowers ? f.duration > 0 && (p === h && 0 === parseFloat(r.css(R.spacer, "padding-top")) ? s = !0 : p === a && 0 === parseFloat(r.css(R.spacer, "padding-bottom")) && (s = !0)) : n[e.vertical ? "top" : "left"] = f.duration * d, r.css(i, n), s && z()
                        } else {
                            "fixed" != r.css(i, "position") && (r.css(i, {
                                position: "fixed"
                            }), z());
                            var u = r.get.offset(R.spacer, !0),
                                c = f.reverse || 0 === f.duration ? e.scrollPos - m.start : Math.round(d * f.duration * 10) / 10;
                            u[e.vertical ? "top" : "left"] += c, r.css(R.spacer.firstChild, {
                                top: u.top,
                                left: u.left
                            })
                        }
                ...
                z = function() {
                    if (E && o && R.inFlow) {
                        ...
                        R.relSize.width || R.relSize.autoFullWidth ? t ? r.css(E, {
                            ...
                            width: "100%"
                        }) : (s["min-width"] = r.get.width(e ? E : i, !0, !0), s.width = t ? s["min-width"] : "auto"), R.relSize.height ? t ? r.css(E, {
                            height: r.get.height(R.spacer) - (R.pushFollowers ? f.duration : 0)
                        }) : r.css(E, {
                            height: "100%"
                        }) : (s["min-height"] = r.get.height(e ? i : E, !0, !n), s.height = t ? s["min-height"] : "auto"), R.pushFollowers && (s["padding" + (e ? "Top" : "Left")] = f.duration * d, s["padding" + (e ? "Bottom" : "Right")] = f.duration * (1 - d)), r.css(R.spacer, s)
                    }
                },
                A = function() {
                    o && E && p === l && !o.info("isDocument") && k()
                },
                M = function() {
                    o && E && p === l && ((R.relSize.width || R.relSize.autoFullWidth) && r.get.width(window) != r.get.width(R.spacer.parentNode) || R.relSize.height && r.get.height(window) != r.get.height(R.spacer.parentNode)) && z()
                },
                L = function(t) {
            ...
            this.setPin = function(t, i) {
                ...
                if (i = r.extend({}, n, i), t = r.get.elements(t)[0], !t) return c;
                if ("fixed" === r.css(t, "position")) return c;
                if (E) {
                    if (E === t) return c;
                    c.removePin()
                }
                ...
                if (a || r.extend(f, r.css(E, ["width", "height"])), r.css(u, f), u.setAttribute(e, ""), r.addClass(u, i.spacerClass), R = {
                        spacer: u,
                        relSize: {
                ...
                }), window.addEventListener("scroll", A), window.addEventListener("resize", A), window.addEventListener("resize", M), E.addEventListener("mousewheel", L), E.addEventListener("DOMMouseScroll", L), k(), c
                ...
                if (E) {
                    if (p === l && k(!0), t || !o) {
                        ...
                        R.spacer.parentNode.insertBefore(i, R.spacer), R.spacer.parentNode.removeChild(R.spacer), E.parentNode.hasAttribute(e) || (r.css(E, E.___origStyle), delete E.___origStyle)
                    }
                    window.removeEventListener("scroll", A), window.removeEventListener("resize", A), window.removeEventListener("resize", M), E.removeEventListener("mousewheel", L), E.removeEventListener("DOMMouseScroll", L), E = void 0
                }
                return c
            };
            var I, D = [];
            return c.on("destroy.internal", function(t) {
                ...
                return 0 !== i.length && r.type.String(e) ? (D.length > 0 && c.removeClassToggle(), I = e, D = i, c.on("enter.internal_class leave.internal_class", function(t) {
                ...
                return t && D.forEach(function(t) {
                    r.removeClass(t, I)
                }), c.off("start.internal_class end.internal_class"), I = void 0, D = [], c
            }, v(), c
        };
        var n = {
            defaults: {
            ...
            return f.elements = function(e) {
                ...
                if ("nodelist" === c(e) || c.Array(e))
                    for (var r = 0, s = i.length = e.length; s > r; r++) {
                        var o = e[r];
                        i[r] = c.DomElement(o) ? o : f.elements(o)
    ...
    function($) {
        $(document).ready(function() {
            ...
            var e = function(t, e) {
                ...
                r = function(t, e) {
                    if (t)
                        if (t.progress(0), t.invalidate(), e)
                            for (var i = t.getChildren(), n = 0; n < i.length; n++) TweenMax.set(i[n].target, {
                                clearProps: "all"
                            });
                        else TweenMax.set(t.target, {
                            clearProps: "all"
                        })
                },
                s = function(t, e) {
                    for (var i = 0; i < e.length; i++)
                        if (t.hasClass(e[i])) return !0;
                    return !1
                };
            ...
            $(".horizontal-half-wrapper .read-more").off("click.read-more").on("click.read-more", function(t) {
                o($(this), ".horizontal-half-wrapper")
            }), $(".flip-out-intro .read-more").off("click.read-more").on("click.read-more", function(t) {
                o($(this), ".flip-out-intro")
            });
            var a = new ScrollMagic.Controller,
                ...
                h = ["scale", "up", "right", "down", "left", "rotate-y", "rotate-x"],
                u = ["fade", "lid-tilt", "phone-arc"],
                c = function(t) {
                    for (var e = "", i = 0; i < t.length; i++) i > 0 && (e += ", "), e += "." + t[i] + "-in, ", e += "." + t[i] + "-in-out, ", e += "." + t[i] + "-out, ", e += "." + t[i] + "-out-in";
                    return e
                },
                f = c(h),
                p = f.replace(/[.]+/g, "").split(", "),
                    ...
                    init: function(t) {
                        ...
                        return this.each(function(o) {
                            var h = $(this),
                                ...
                                f = h.attr("data-staggereddelay") || t.staggeredDelay,
                                y = t.reset;
                            if (!h.parent(".fb").length || !s(h, m)) {
                                var T = !1,
                                    w = h.attr("data-id");
                                w || (v++, w = v, h.attr("data-id", w), T = !0);
                                var x = $("nav.n").first(),
                                    b = h.offset().top,
                                    ...
                                    R = function(t) {
                                        "FORWARD" === t.scrollDirection ? (x.removeClass("fj"), x.addClass("ao")) : (x.addClass("fj"), x.removeClass("ao"))
                                    };
                                if (window.innerWidth >= c) {
                                    if (h.hasClass("gh")) {
                                        ...
                                        var L = h.find(".laptop-preview-sizer"),
                                            ...
                                            W = function(t) {
                                                "FORWARD" === t.scrollDirection ? (x.addClass("ao"), setTimeout(function() {
                                                    x.css("opacity", "")
                                                }, 0)) : (x.removeClass("ao"), setTimeout(function() {
                                                    x.css("opacity", 0)
                                                }, 0))
                                            },
                                            A = new ScrollMagic.Scene({
                                                duration: O
                                            }).setTween(D).setPin(h[0]).on("end", j).addTo(a),
                                            B = new ScrollMagic.Scene({
                                                duration: M
                                            }).setTween(F).on("end", W).addTo(a),
                                        ...
                                        var A = new ScrollMagic.Scene({
                                            duration: C
                                        }).setTween(U).setPin(h[0]).on("end", R).addTo(a);
                                        g[w] = {
                                            type: l.phoneWall,
                                            sceneTweenPairs: [{
                                                scene: A,
                                        ...
                                        A = G ? new ScrollMagic.Scene({
                                            duration: C
                                        }).setTween(z).addTo(a) : new ScrollMagic.Scene({
                                            triggerElement: h[0],
                                            triggerHook: "onEnter",
                                            duration: V
                                        }).setTween(z).addTo(a), g[w] = {
                                            type: l.flipOut,
                                            sceneTweenPairs: [{
                                                scene: A,
                                                tween: z,
                                        ...
                                        h.find(".circle-reveal-wrapper").each(function(t) {
                                            ...
                                            e.css("z-index", tt - t), J.to(n, 1, {
                                                ...
                                                ease: Power2.easeInOut,
                                                onComplete: function() {
                                                    e.next(".circle-reveal-wrapper").find(".circle-background").hasClass("l") ? x.addClass("bi") : x.removeClass("bi"), e.css("pointer-events", "none")
                                                },
                                                onReverseComplete: function() {
                                                    var t = e.prev(".circle-reveal-wrapper").length ? e.prev(".circle-reveal-wrapper") : e;
                                                    t.find(".circle-background").hasClass("l") ? x.addClass("bi") : x.removeClass("bi"), e.css("pointer-events", "")
                                                }
                                            }).to({}, .5, {})
                                        });
                                        var A = new ScrollMagic.Scene({
                                                ...
                                                triggerHook: "onLeave",
                                                duration: it
                                            }).setTween(J).setPin(h[0]).addTo(a),
                                            B = new ScrollMagic.Scene({
                                                triggerElement: h[0],
                                                triggerHook: "onLeave",
                                                duration: it
                                            }).setTween(K).on("end", function(t) {
                                                E(t), "FORWARD" === t.scrollDirection ? et.addClass("end") : et.removeClass("end")
                                            }).addTo(a);
                                        g[w] = {
                                            type: l.circleReveal,
                                            sceneTweenPairs: [{
                                        ...
                                        var nt = h.find(".phone-preview-sizer"),
                                            rt = h.find(".horizontal-half-wrapper"),
                                            it = function() {
                                                return window.innerHeight * (2 * rt.length - 1)
                                            },
                                            st = new TimelineMax,
                                            ot = new TimelineMax,
                                            K = new TimelineMax;
                                        rt.each(function(t) {
                                            var e = $(this).hasClass("he") ? "right" : "left",
                                                ...
                                                a = function(t) {
                                                    var e = nt.find(".image-container"),
                                                        i = e.eq(t);
                                                    i.length && (e.removeClass("g"), i.addClass("g"))
                                                },
                                                l = $(this).find(".header-wrapper"),
                                                h = $(this).find(".header-background");
                                            0 === t && ot.set($(this), {
                                                zIndex: 1
                                            }), $(this).hasClass("g") || (i.left = "right" === e ? "25%" : "75%", i.onStart = function() {
                                                a(t)
                                            }, i.onReverseComplete = function() {
                                                a(t - 1)
                                            }, st.to(nt, .8, i), st.to({}, .2, {}), ot.set($(this), {
                                                zIndex: 1
                                            }), n[e] = "+=100%", ot.to(h, 1, n), r[e] = "+=50px", K.to(l, .5, r)), st.to(nt, .8, {
                                                left: "50%",
                                                ease: Power4.easeInOut,
                                                delay: .2
                                            }), s[e] = "-=100%", ot.to(h, 1, s), ot.set($(this), {
                                                zIndex: -1
                                            }), o[e] = "-=50px", K.to(l, .5, o), K.to({}, .5, {})
                                        });
                                        var at = new ScrollMagic.Scene({
                                                triggerElement: h[0],
                                                triggerHook: "onLeave",
                                                duration: it
                                            }).setTween(st).setPin(h[0]).addTo(a),
                                            B = new ScrollMagic.Scene({
                                                triggerElement: h[0],
                                                triggerHook: "onLeave",
                                                duration: it
                                            ...
                                            X = new ScrollMagic.Scene({
                                                ...
                                                triggerHook: "onLeave",
                                                duration: it
                                            }).setTween(K).on("end", R).addTo(a);
                                        g[w] = {
                                            type: l.horizontalHalf,
                                            sceneTweenPairs: [{
                                                scene: at,
                                                tween: st,
                                                isTimeline: !0
                                        ...
                                        var lt = i(u, "100%"),
                                            ht = h.innerHeight() - window.innerHeight,
                                            at = new ScrollMagic.Scene({
                                                triggerElement: h[0],
                                                triggerHook: "onLeave",
                                                duration: lt,
                                                offset: ht
                                ...
                                } else h.attr("data-disabled", !0);
                                var dt = e(function() {
                                    var t = window.innerWidth,
                                        e = "true" === h.attr("data-disabled");
                                    if (e) window.innerWidth >= c && (h.attr("data-disabled", !1), h.scrollTransition({
                                        reset: !1
                                    }));
                                    else {
                                        for (var i = g[w].type, n = g[w].sceneTweenPairs, s = 0; s < n.length; s++) {
                                            var o = n[s].tween,
                                                a = n[s].isTimeline === !0,
                                                l = n[s].scene;
                                            window.innerWidth < c && h.attr("data-disabled", !0), r(o, a), l.destroy(!0)
                                        }
                                ...
                                $(window).off("resize.scrollTransition" + w).on("resize.scrollTransition" + w, dt)
                            }
                        })
                    },
                    destroy: function() {
                        for (var t = $(this), e = t.attr("data-id"), i = g[e].type, n = g[e].sceneTweenPairs, s = 0; s < n.length; s++) {
                            var o = n[s].tween,
                                a = n[s].isTimeline === !0,
                                l = n[s].scene;
                            t.attr("data-disabled", !0), r(o, a), l.destroy(!0)
                        }
                        t.attr("data-id", ""), delete g[e], $(window).off("resize.scrollTransition" + e)
                    }
                };
            $.fn.scrollTransition = function(t) {
                return y[t] ? y[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void $.error("Method " + t + " does not exist on jQuery.scrollTransition") : y.init.apply(this, arguments)
            }, $(".gh").scrollTransition(), $(".gn").scrollTransition(), $(".gg").scrollTransition(), $(".gl").scrollTransition(), $(".ga").scrollTransition(), $(".fh").scrollTransition(), $(".fr").scrollTransition(), $(".fn").scrollTransition(), $(".fb").scrollTransition(), $(d).scrollTransition(), $(window).on("scroll.navbar", function() {
                var t = $("nav.n").first();
                t.hasClass("fq") && ($(window).scrollTop() > 0 ? t.addClass("ao") : t.removeClass("ao"))
            });
            var T = $(".masonry-grid");
            if (T.length && T.imagesLoaded(function() {
                    T.masonry({
                        columnWidth: ".col",
                        itemSelector: ".col"
                    })
                ...
                var w = 37.7576793,
                    ...
                    b = "#7CFFE6",
                    P = "#fafafa",
                    S = "123 Main Street, San Francisco, CA 94110",
                    C = $(".google-map").first();
                C.length && t(C[0], b, P, w, x, S)
            }
        })
    }(jQuery),
    function($) {
        $(function() {
            $(".carousel.carousel-slider").carousel({
                fullWidth: !0
            }), $(".carousel").carousel(), $(".slider").slider(), $(".parallax").parallax(), $(".modal").modal(), $(".scrollspy").scrollSpy(), $(".button-collapse").sideNav({
                edge: "left"
            }), $(".datepicker").pickadate({
                selectYears: 20
            }), $("select").not(".disabled").material_select(), $("input.autocomplete").autocomplete({
                data: {
                    Apple: null,
                    Microsoft: null,
